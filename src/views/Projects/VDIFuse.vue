...
import CppLogo from '@/assets/ext-logos/cpp-logo.svg'
import CLogo from '@/assets/ext-logos/c-logo.svg'
...
<template>
  ...
  >
    <p>
      This program allows you to mount a Virtual Disk Image (VDI) file used by VirtualBox onto a
    ...
    <img
      class="border-darcula-500 rounded border"
