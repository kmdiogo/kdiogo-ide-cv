...
<template>
    <div class="flex flex-col flex-shrink-0 h-screen font-body bg-darcula-700 text-darcula-200"
    ...
    >
        ...
        <div class="flex flex-grow">
            <ResizableContainer class="bg-darcula-500 flex-shrink-0 hidden md:flex" initial-size="250px">
